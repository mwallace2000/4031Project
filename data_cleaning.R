...
#pred_data <- pred_data[c(-20,-32,-27,-82,-8,-30,-124),]
g = lm(pred_data$Percent_Change_in_Median_Home_Value_2014_to_2018~., na.action=na.exclude, data=pred_data[,c(-1,-2,-4)],x=TRUE)
summary(g)
...
plot(pred_data[,c(5,6,9,11,12,13,17,18,19,23,24,15)])
